...
public class ERP_Financial_Webservice_MainClass extends ReporterBaseTest {
	...
	public void OracleCloud_Financial_Webservices(String inputfile_fp, String GIfile_fp) throws Exception {
		try {
			...
			try {
				file = new FileInputStream(new File(inputfile_fp));
				...
				Logger.logError(ERP_Financial_Webservice_MainClass.class,
						"File is not in valid format.Please select correct file");
			...
			try {
				...
				test.log(Status.FAIL, "Step 1: File is not in valid format.Please select correct file");
				Logger.logError(ERP_Financial_Webservice_MainClass.class,
						"Step 1: File is not in valid format.Please select correct file");
				all.add(d);
				booleanstatus = false;
				e1.printStackTrace();
			...
			for (int currentColumnNum = 0; currentColumnNum < 1; currentColumnNum++) {
				for (int currentRowNum = ips1.getFirstRowNum() + 1; currentRowNum <= ips1.getLastRowNum(); currentRowNum++) {
					...
					if (cellvalue_uFileName.equals("GlInterface.zip")) {
					...
					cellvalue_uContentType = cu.getCellFormattedStringValue(cells_uContentType.get(currentRowNum),
							workbook);

					cells_uDocumenTtitle = cu.columnIdentification("UFTU_DocumentTitle", ips1);
					System.out.println(cells_uDocumenTtitle);
					cellvalue_uDocumentTitle = cu.getCellFormattedStringValue(cells_uDocumenTtitle.get(currentRowNum),
							workbook);

					cells_uDocumentAuthor = cu.columnIdentification("UFTU_DocumentAuthor", ips1);
					System.out.println(cells_uDocumentAuthor);
					cellvalue_uDocumentAuthor = cu.getCellFormattedStringValue(cells_uDocumentAuthor.get(currentRowNum),
							workbook);
					...
					cellvalue_uDocumentSecurityGroup = cu
							.getCellFormattedStringValue(cells_uDocumentSecurityGroup.get(currentRowNum), workbook);

					cells_uDocumentAccount = cu.columnIdentification("UFTU_DocumentAccount", ips1);
					System.out.println(cells_uDocumentAccount);
					cellvalue_uDocumentAccount = cu
							.getCellFormattedStringValue(cells_uDocumentAccount.get(currentRowNum), workbook);

					cells_uDocumentName = cu.columnIdentification("UFTU_DocumentName", ips1);
					System.out.println(cells_uDocumentName);
					cellvalue_uDocumentName = cu.getCellFormattedStringValue(cells_uDocumentName.get(currentRowNum),
							workbook);

					cells_uDocumentID = cu.columnIdentification("UFTU_DocumentId", ips1);
					System.out.println(cells_uDocumentID);
					cellvalue_uDocumentID = cu.getCellFormattedStringValue(cells_uDocumentID.get(currentRowNum),
							workbook);

					cells_ujobPackageName = cu.columnIdentification("SEJRLoader_jobPackageName", ips1);
					System.out.println(cells_ujobPackageName);
					cellvalue_ujobPackageName = cu.getCellFormattedStringValue(cells_ujobPackageName.get(currentRowNum),
							workbook);
					...
					cellvalue_ujobDefinitionName = cu
							.getCellFormattedStringValue(cells_ujobDefinitionName.get(currentRowNum), workbook);

					cells_uLoaderParamList1 = cu.columnIdentification("SEJRLoader_ParamList1", ips1);
					System.out.println(cells_uLoaderParamList1);
					cellvalue_uLoaderParamList1 = cu
							.getCellFormattedStringValue(cells_uLoaderParamList1.get(currentRowNum), workbook);

					cells_uLoaderParamList2 = cu.columnIdentification("SEJRLoader_ParamList2", ips1);
					System.out.println(cells_uLoaderParamList2);
					cellvalue_uLoaderParamList2 = cu
							.getCellFormattedStringValue(cells_uLoaderParamList2.get(currentRowNum), workbook);

					cells_uLoaderParamList3 = cu.columnIdentification("SEJRLoader_ParamList3", ips1);
					System.out.println(cells_uLoaderParamList3);
					cellvalue_uLoaderParamList3 = cu
							.getCellFormattedStringValue(cells_uLoaderParamList3.get(currentRowNum), workbook);
					...
					cellvalue_uImportjobPackageName = cu
							.getCellFormattedStringValue(cells_uImportjobPackageName.get(currentRowNum), workbook);

					cells_uImportjobDefinitionName = cu.columnIdentification("SEJRRequestImport_jobDefinitionName",
							ips1);
					System.out.println(cells_uImportjobDefinitionName);
					cellvalue_uImportjobDefinitionName = cu
							.getCellFormattedStringValue(cells_uImportjobDefinitionName.get(currentRowNum), workbook);
					...
					cellvalue_uImportParamList1 = cu
							.getCellFormattedStringValue(cells_uImportParamList1.get(currentRowNum), workbook);

					cells_uImportParamList2 = cu.columnIdentification("SEJRRequestImport_ParamList2", ips1); // Changes
																												// made
																												// SEJRRequestImport_PL2_JournalSource
					System.out.println(cells_uImportParamList2);
					cellvalue_uImportParamList2 = cu
							.getCellFormattedStringValue(cells_uImportParamList2.get(currentRowNum), workbook);

					cells_uImportParamList3 = cu.columnIdentification("SEJRRequestImport_ParamList3", ips1); // Changes
																												// made
																												// SEJRRequestImport_PL3_LedgerID
					System.out.println(cells_uImportParamList3);
					cellvalue_uImportParamList3 = cu
							.getCellFormattedStringValue(cells_uImportParamList3.get(currentRowNum), workbook);

					cells_uImportParamList4 = cu.columnIdentification("SEJRRequestImport_ParamList4", ips1); // Changes
																												// made
																												// SEJRRequestImport_PL4_GroupID
					System.out.println(cells_uImportParamList4);
					cellvalue_uImportParamList4 = cu
							.getCellFormattedStringValue(cells_uImportParamList4.get(currentRowNum), workbook);
					...
					cellvalue_uImportParamList5 = cu
							.getCellFormattedStringValue(cells_uImportParamList5.get(currentRowNum), workbook);
					...
					cellvalue_uImportParamList6 = cu
							.getCellFormattedStringValue(cells_uImportParamList6.get(currentRowNum), workbook);
					...
					cellvalue_uImportParamList7 = cu
							.getCellFormattedStringValue(cells_uImportParamList7.get(currentRowNum), workbook);
					break;
				}
			...
			// HttpURLConnectin conn = (HttpURLConnection)url.openConnection();
			...
			if (booleanstatus) {
				...
				try {
					...
					Logger.logError(ERP_Financial_Webservice_MainClass.class,
							"Step 2: Content conversion to Base64 failed: " + e);
					e.printStackTrace();
			...
			if (booleanstatus) {
				...
				resultuploadFile = euftu.triggerUploadFileToUcm(auth, encStr, cellvalue_uFileName,
						cellvalue_uContentType, cellvalue_uDocumentTitle, cellvalue_uDocumentAuthor,
						cellvalue_uDocumentSecurityGroup, cellvalue_uDocumentAccount, cellvalue_uDocumentName,
						cellvalue_uDocumentID);
				if (resultuploadFile.contains("Error")) {
					booleanstatus = false;
					Logger.logError(ERP_Financial_Webservice_MainClass.class,
							"Step 3: uploadFileToUcm Failed.Please contact Functional team:" + resultuploadFile);
			...
			if (booleanstatus) {
				...
				resultsubmitESSJobRequest_Loader = esejr.triggersubmitESSJobRequest_Loader(auth, resultuploadFile,
						cellvalue_ujobPackageName, cellvalue_ujobDefinitionName, cellvalue_uLoaderParamList1,
						cellvalue_uLoaderParamList2, cellvalue_uLoaderParamList3);
				if (resultsubmitESSJobRequest_Loader.contains("Error")) {
					booleanstatus = false;
					Logger.logError(ERP_Financial_Webservice_MainClass.class,
							"Step 4: Load File to Interface unsuccessful: ");
					...
					Logger.logError(ERP_Financial_Webservice_MainClass.class,
							"Step 4: Load File to Interface Successful");
			...
			if (booleanstatus) {
				...
				while (!resultgetESSJobStatus_Loader.equals("SUCCEEDED")) {
					...
					if (resultgetESSJobStatus_Loader.contains("ERROR")
							|| resultgetESSJobStatus_Loader.contains("Error")) {
						booleanstatus = false;
						Logger.logError(ERP_Financial_Webservice_MainClass.class,
								"Step 5: Load File to Interface Job resulted in Error, Check reason befor proceeding");
						test.log(Status.FAIL,
								"Step 5: Load File to Interface Job resulted in Error, Check reason befor proceeding");
			...
			if (booleanstatus) {
				...
				resultsubmitESSJobRequest_ReqImport = esejri.triggersubmitESSJobRequest_ReqImport(auth,
						cellvalue_uImportjobPackageName, cellvalue_uImportjobDefinitionName,
						cellvalue_uImportParamList1, cellvalue_uImportParamList2, cellvalue_uImportParamList3,
						cellvalue_uImportParamList4, cellvalue_uImportParamList5, cellvalue_uImportParamList6,
						cellvalue_uImportParamList7);
				if (resultsubmitESSJobRequest_ReqImport.contains("Error")) {
					...
					Logger.logError(ERP_Financial_Webservice_MainClass.class,
							"Step 6: Journal Import Job execution unsuccessful: ");
					booleanstatus = false;
			...
			if (booleanstatus) {
				...
				while (!resultgetESSJobStatus_ReqImport.equals("SUCCEEDED")) {
					resultgetESSJobStatus_ReqImport = egejsi.triggergetESSJobStatus(auth,
							resultsubmitESSJobRequest_ReqImport);
					Thread.sleep(20000);
					if (resultgetESSJobStatus_ReqImport.contains("Error")
							|| resultgetESSJobStatus_ReqImport.contains("ERROR")) {
						booleanstatus = false;
						Logger.logError(ERP_Financial_Webservice_MainClass.class,
								"Step 7: Journal Import Job resulted in Error, Check reason befor proceeding");
						test.log(Status.FAIL,
								"Step 7: Journal Import Job resulted in Error, Check reason befor proceeding");
				...
				Logger.logInfo(ERP_Financial_Webservice_MainClass.class,
						"Step 7: Journal Import Job Status successful");
			}
			...
			if (booleanstatus) {
				...
				String resultsubmitESSJobRequest_ReqImport_New1 = Integer
						.toString(resultsubmitESSJobRequest_ReqImport_New);
				String retunrstatus = edejed.triggerdownloadESSJobExecutionDetails(auth,
						resultsubmitESSJobRequest_ReqImport_New1, resultsubmitESSJobRequest_ReqImport_New);
				if (retunrstatus.contains("Error")) {
					test.log(Status.FAIL, "Step 8: Download of Journal Import File unsuccessful");
					Logger.logError(ERP_Financial_Webservice_MainClass.class,
							"Step 8: Download of Journal Import File unsuccessful");
					booleanstatus = false;
					throw new Exception("Step 8: Download of Journal Import File unsuccessful");
				} else {
					File f = new File(
							"C:\\Automation_OCTS\\Output\\" + resultsubmitESSJobRequest_ReqImport_New + ".zip");
					if (f.exists()) {
						zipFilePath = "C:\\Automation_OCTS\\Output\\" + resultsubmitESSJobRequest_ReqImport_New
								+ ".zip";
						System.out.println("Output File exists");
						Logger.logInfo(ERP_Financial_Webservice_MainClass.class,
								"Step 8: Download of Journal Import File successful");
		...
		// unzip the GI Interface file to enable comparison with Output file to validate
		// number of lines
